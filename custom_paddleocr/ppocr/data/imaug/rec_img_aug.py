...
from custom_paddleocr.ppocr.data.imaug.abinet_aug import CVGeometry, CVDeterioration, CVColorJitter
from custom_paddleocr.ppocr.data.imaug.text_image_aug import tia_perspective, tia_stretch, tia_distort
