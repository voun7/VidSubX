...
logger = get_logger()
from custom_paddleocr.ppocr.utils.utility import check_and_read, get_image_file_list
...
from custom_paddleocr.ppstructure.utility import init_args, draw_structure_result
from custom_paddleocr.ppstructure.predict_system import StructureSystem, save_structure_res
