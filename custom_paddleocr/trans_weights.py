...
def trans():
    ...
    paddle_dict = {}
    fc_names = ["qkv.weight", "fc1.weight", "fc2.weight", "downsample.reduction.weight", "head.weight",
                "attn.proj.weight"]
    fc_names = []
...
def trans_sar():
    ...
    # pdb.set_trace()
    paddle_dict = {}
    fc_names = ["encoder.linear.weight", "decoder.prediction.weight", "decoder.conv1x1_1.weight",
                "decoder.conv1x1_2.weight"]
    for key in state_dict:
        weight = state_dict[key].cpu().numpy()
