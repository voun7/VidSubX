...
class MLM_VRM(nn.Layer):
    ...
    def __init__(self, ):
        ...
        self.Prediction = Prediction(n_dim=512, n_position=256, N_max_character=26,
...
class VisionLAN(nn.Layer):
    ...
    def forward(self, x, label_pos, training_step, train_mode=True):
        ...
        # MLM + VRM
        if train_mode:
            text_pre, test_rem, text_mas, mask_map = self.MLM_VRM(features, label_pos, training_step,
